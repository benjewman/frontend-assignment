    ...
    <div className="app">
      <div className="menu">
        ...
        <div className="menu__navigation">
          <button className="menu__navigation--focus">About</button>
          <button>Blog</button>
          <button>Home</button>
        </div>
      </div>
      ...
      <div className="footer">
        <span className="footer__item">© 2020 Travelize</span>
        <span className="footer__item">Privacy Policy Terms and conditions</span>
      </div>
    </div>
  );
}
